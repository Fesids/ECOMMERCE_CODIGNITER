...
$route['cart/aplicar_cupom'] = 'cart/aplicar_cupom';
$route['cart/remover_cupom'] = 'cart/remover_cupom';

$route['cart/add/(:num)'] = 'cart/add/$1';
$route['cart'] = 'cart/view';
$route['cart/update'] = 'cart/update';
$route['cart/remove/(:num)'] = 'cart/remove/$1';
$route['checkout'] = 'pedidos/checkout';
$route['checkout/processar'] = 'pedidos/process_checkout';
$route['webhook/atualizar-pedido'] = 'webhook/atualizar_pedido';